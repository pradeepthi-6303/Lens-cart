...
public class UserServiceImplTest {
    ...
    void setUp() {
        ...
        user = new Users(1L, "John", "Doe", "johndoe", "password123", "johndoe@example.com", Set.of(UserRole.CUSTOMER));
    }
    ...
    void testRegisterUser() {
        ...
        Users registeredUser = userService.registerUser("John", "Doe", "johndoe", "password123", "johndoe@example.com", Set.of(UserRole.CUSTOMER));
